...
class LearningAgent(Agent):
    ...
    def choose_action(self, state):
        ...
        if self.learning:
            random_number = random.uniform(0.01, 1.00)
    ...
    def learn(self, state, action, reward):
        ...
        if self.learning:
            ...
            self.Q[state][action] = old_value * (1 - self.alpha) + self.alpha * reward
...
def run():
    ...
    agent = env.create_agent(LearningAgent, learning=True, alpha=0.75, epsilon=1.0)
